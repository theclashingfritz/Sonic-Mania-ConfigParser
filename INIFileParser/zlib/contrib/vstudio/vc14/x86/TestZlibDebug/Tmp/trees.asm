; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\theclashingfritz\source\repos\INIFileParser\zlib\trees.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\theclashingfritz\source\repos\inifileparser\zlib\trees.c
_TEXT	SEGMENT
_s$ = 8							; size = 4
__tr_init PROC
...
; 419  :     s->last_lit = s->matches = 0;
	...
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5808], 0
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], 0
...
; 869  :     send_bits(s, (STORED_BLOCK<<1)+last, 3);    /* send block type */
	...
	mov	DWORD PTR _len$80823[ebp], 3
	mov	eax, 16					; 00000010H
	sub	eax, DWORD PTR _len$80823[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [ecx+5820], eax
	jle	$LN2@tr_stored_
	mov	edx, DWORD PTR _last$[ebp]
	mov	DWORD PTR _val$80826[ebp], edx
	...
	mov	ecx, DWORD PTR _len$80823[ebp]
...
$LN2@tr_stored_:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80823[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
...
; Function compile flags: /Odtp
_TEXT	SEGMENT
_val$80875 = -16					; size = 4
_len$80872 = -12					; size = 4
_val$80861 = -8						; size = 4
_len$80858 = -4						; size = 4
_s$ = 8							; size = 4
__tr_align PROC
...
; 899  :     send_bits(s, STATIC_TREES<<1, 3);
	...
	mov	DWORD PTR _len$80858[ebp], 3
	mov	eax, 16					; 00000010H
	sub	eax, DWORD PTR _len$80858[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [ecx+5820], eax
	jle	$LN4@tr_align
	mov	DWORD PTR _val$80861[ebp], 2
	movzx	edx, WORD PTR _val$80861[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80858[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN4@tr_align:
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	add	ecx, DWORD PTR _len$80858[ebp]
	mov	edx, DWORD PTR _s$[ebp]
...
; 900  :     send_code(s, END_BLOCK, static_ltree);
	...
	mov	DWORD PTR _len$80872[ebp], eax
	mov	ecx, 16					; 00000010H
	sub	ecx, DWORD PTR _len$80872[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [edx+5820], ecx
	jle	$LN2@tr_align
	movzx	eax, WORD PTR _static_ltree+1024
	mov	DWORD PTR _val$80875[ebp], eax
	movzx	edx, WORD PTR _val$80875[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80872[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
	jmp	SHORT $LN1@tr_align
$LN2@tr_align:
	movzx	edx, WORD PTR _static_ltree+1024
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80872[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN1@tr_align:
...
; Function compile flags: /Odtp
_TEXT	SEGMENT
_val$80926 = -28					; size = 4
_len$80923 = -24					; size = 4
_val$80909 = -20					; size = 4
_len$80906 = -16					; size = 4
_opt_lenb$ = -12					; size = 4
...
; 978  :         send_bits(s, (STATIC_TREES<<1)+last, 3);
	...
	mov	DWORD PTR _len$80906[ebp], 3
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$80906[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN6@tr_flush_b
	mov	ecx, DWORD PTR _last$[ebp]
	add	ecx, 2
	mov	DWORD PTR _val$80909[ebp], ecx
	movzx	edx, WORD PTR _val$80909[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80906[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN6@tr_flush_b:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80906[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN5@tr_flush_b:
...
; 985  :         send_bits(s, (DYN_TREES<<1)+last, 3);
	...
	mov	DWORD PTR _len$80923[ebp], 3
	mov	eax, 16					; 00000010H
	sub	eax, DWORD PTR _len$80923[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [ecx+5820], eax
	jle	$LN3@tr_flush_b
	mov	edx, DWORD PTR _last$[ebp]
	add	edx, 4
	mov	DWORD PTR _val$80926[ebp], edx
	movzx	eax, WORD PTR _val$80926[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [ecx+5820]
	shl	eax, cl
	mov	edx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80923[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN3@tr_flush_b:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80923[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN2@tr_flush_b:
...
; 665  :         pqremove(s, tree, n);  /* n = node of least frequency */
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+edx*4+2908]
	mov	DWORD PTR [eax+2912], edx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5200]
	sub	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5200], ecx
	push	1
...
$LN20@build_tree:
	...
	mov	BYTE PTR [ecx+5208], al

; 675  :         tree[n].Dad = tree[m].Dad = (ush)node;

	mov	edx, DWORD PTR _m$[ebp]
	mov	eax, DWORD PTR _tree$[ebp]
	mov	cx, WORD PTR _node$[ebp]
...
; 597  :         int len = tree[n].Len;
	...
	mov	eax, DWORD PTR _tree$[ebp]
	movzx	ecx, WORD PTR [eax+edx*4+2]
	mov	DWORD PTR _len$80530[ebp], ecx

; 598  :         if (len == 0) continue;

	cmp	DWORD PTR _len$80530[ebp], 0
...
; 600  :         tree[n].Code = (ush)bi_reverse(next_code[len]++, len);
	...
	mov	edx, DWORD PTR _len$80530[ebp]
	movzx	eax, WORD PTR _next_code$[ebp+edx*2]
	mov	DWORD PTR tv93[ebp], eax
	mov	ecx, DWORD PTR _len$80530[ebp]
	mov	dx, WORD PTR _next_code$[ebp+ecx*2]
	add	dx, 1
	mov	eax, DWORD PTR _len$80530[ebp]
...
; 720  :         curlen = nextlen; nextlen = tree[n+1].Len;
	...
	mov	DWORD PTR _curlen$[ebp], ecx
	mov	edx, DWORD PTR _n$[ebp]
	mov	eax, DWORD PTR _tree$[ebp]
	movzx	ecx, WORD PTR [eax+edx*4+6]
	mov	DWORD PTR _nextlen$[ebp], ecx
...
; 721  :         if (++count < max_count && curlen == nextlen) {
	...
	cmp	eax, DWORD PTR _max_count$[ebp]
...
; 727  :             s->bl_tree[REP_3_6].Freq++;
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+2748]
	add	ax, 1
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+2748], ax
...
; 729  :             s->bl_tree[REPZ_3_10].Freq++;
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+2752]
	add	ax, 1
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+2752], ax
...
; 731  :             s->bl_tree[REPZ_11_138].Freq++;
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+2756]
	add	ax, 1
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+2756], ax
$LN12@scan_tree:
...
_scan_tree ENDP
; Function compile flags: /Odtp
_val$80804 = -36					; size = 4
_len$80801 = -32					; size = 4
_val$80787 = -28					; size = 4
_len$80784 = -24					; size = 4
_val$80773 = -20					; size = 4
_len$80770 = -16					; size = 4
_val$80759 = -12					; size = 4
_len$80756 = -8						; size = 4
_rank$ = -4						; size = 4
_s$ = 8							; size = 4
_lcodes$ = 12						; size = 4
...
; 844  :     send_bits(s, lcodes-257, 5); /* not +255 as stated in appnote.txt */
	...
	mov	DWORD PTR _len$80756[ebp], 5
	mov	eax, 16					; 00000010H
	sub	eax, DWORD PTR _len$80756[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [ecx+5820], eax
	jle	$LN11@send_all_t
	mov	edx, DWORD PTR _lcodes$[ebp]
	sub	edx, 257				; 00000101H
	mov	DWORD PTR _val$80759[ebp], edx
	movzx	eax, WORD PTR _val$80759[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [ecx+5820]
	shl	eax, cl
	mov	edx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80756[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN11@send_all_t:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80756[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN10@send_all_t:
...
; 845  :     send_bits(s, dcodes-1,   5);
	...
	mov	DWORD PTR _len$80770[ebp], 5
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$80770[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN9@send_all_t
	mov	ecx, DWORD PTR _dcodes$[ebp]
	sub	ecx, 1
	mov	DWORD PTR _val$80773[ebp], ecx
	movzx	edx, WORD PTR _val$80773[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80770[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN9@send_all_t:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80770[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN8@send_all_t:
...
; 846  :     send_bits(s, blcodes-4,  4); /* not -3 as stated in appnote.txt */
	...
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$80784[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN7@send_all_t
	mov	ecx, DWORD PTR _blcodes$[ebp]
	sub	ecx, 4
	mov	DWORD PTR _val$80787[ebp], ecx
	movzx	edx, WORD PTR _val$80787[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80784[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN7@send_all_t:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80784[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN6@send_all_t:
...
; 849  :         send_bits(s, s->bl_tree[bl_order[rank]].Len, 3);
	...
	mov	DWORD PTR _len$80801[ebp], 3
	mov	ecx, 16					; 00000010H
	sub	ecx, DWORD PTR _len$80801[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [edx+5820], ecx
	jle	$LN2@send_all_t
	mov	eax, DWORD PTR _rank$[ebp]
	...
	mov	DWORD PTR _val$80804[ebp], eax
	movzx	edx, WORD PTR _val$80804[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80801[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN2@send_all_t:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80801[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN1@send_all_t:
...
; Function compile flags: /Odtp
_val$80722 = -92					; size = 4
_len$80719 = -88					; size = 4
_val$80708 = -84					; size = 4
_len$80705 = -80					; size = 4
_val$80693 = -76					; size = 4
_len$80690 = -72					; size = 4
_val$80679 = -68					; size = 4
_len$80676 = -64					; size = 4
_val$80663 = -60					; size = 4
_len$80660 = -56					; size = 4
_val$80649 = -52					; size = 4
_len$80646 = -48					; size = 4
_val$80635 = -44					; size = 4
_len$80632 = -40					; size = 4
_val$80618 = -36					; size = 4
_len$80615 = -32					; size = 4
_max_count$ = -28					; size = 4
_min_count$ = -24					; size = 4
_prevlen$ = -20						; size = 4
_nextlen$ = -16						; size = 4
...
; 769  :             do { send_code(s, curlen, s->bl_tree); } while (--count != 0);
	...
	mov	ecx, DWORD PTR _s$[ebp]
	movzx	edx, WORD PTR [ecx+eax*4+2686]
	mov	DWORD PTR _len$80615[ebp], edx
	mov	eax, 16					; 00000010H
	sub	eax, DWORD PTR _len$80615[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [ecx+5820], eax
	jle	$LN26@send_tree
	mov	edx, DWORD PTR _curlen$[ebp]
	...
	mov	DWORD PTR _val$80618[ebp], ecx
	movzx	edx, WORD PTR _val$80618[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80615[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN26@send_tree:
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	add	ecx, DWORD PTR _len$80615[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5820], ecx
$LN28@send_tree:
	mov	eax, DWORD PTR _count$[ebp]
...
; 773  :                 send_code(s, curlen, s->bl_tree); count--;
	...
	mov	DWORD PTR _len$80632[ebp], ecx
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$80632[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN21@send_tree
	mov	ecx, DWORD PTR _curlen$[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	movzx	eax, WORD PTR [edx+ecx*4+2684]
	mov	DWORD PTR _val$80635[ebp], eax
	movzx	edx, WORD PTR _val$80635[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80632[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN21@send_tree:
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	add	ecx, DWORD PTR _len$80632[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5820], ecx
$LN20@send_tree:
	mov	eax, DWORD PTR _count$[ebp]
...
; 776  :             send_code(s, REP_3_6, s->bl_tree); send_bits(s, count-3, 2);
	...
	jle	$LN19@send_tree
	mov	edx, DWORD PTR _s$[ebp]
	movzx	eax, WORD PTR [edx+2748]
	mov	DWORD PTR _val$80649[ebp], eax
	movzx	edx, WORD PTR _val$80649[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80646[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN19@send_tree:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80646[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN18@send_tree:
	mov	DWORD PTR _len$80660[ebp], 2
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$80660[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN17@send_tree
	mov	ecx, DWORD PTR _count$[ebp]
	sub	ecx, 3
	mov	DWORD PTR _val$80663[ebp], ecx
	movzx	edx, WORD PTR _val$80663[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80660[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN17@send_tree:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80660[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN16@send_tree:
	jmp	$LN31@send_tree
...
; 779  :             send_code(s, REPZ_3_10, s->bl_tree); send_bits(s, count-3, 3);
	...
	mov	edx, DWORD PTR _s$[ebp]
	movzx	eax, WORD PTR [edx+2754]
	mov	DWORD PTR _len$80676[ebp], eax
	mov	ecx, 16					; 00000010H
	sub	ecx, DWORD PTR _len$80676[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [edx+5820], ecx
	jle	$LN13@send_tree
	mov	eax, DWORD PTR _s$[ebp]
	movzx	ecx, WORD PTR [eax+2752]
	mov	DWORD PTR _val$80679[ebp], ecx
	movzx	edx, WORD PTR _val$80679[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80676[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN13@send_tree:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80676[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN12@send_tree:
	mov	DWORD PTR _len$80690[ebp], 3
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$80690[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN11@send_tree
	mov	ecx, DWORD PTR _count$[ebp]
	sub	ecx, 3
	mov	DWORD PTR _val$80693[ebp], ecx
	movzx	edx, WORD PTR _val$80693[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80690[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN11@send_tree:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80690[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN10@send_tree:
...
; 782  :             send_code(s, REPZ_11_138, s->bl_tree); send_bits(s, count-11, 7);
	...
	mov	edx, DWORD PTR _s$[ebp]
	movzx	eax, WORD PTR [edx+2758]
	mov	DWORD PTR _len$80705[ebp], eax
	mov	ecx, 16					; 00000010H
	sub	ecx, DWORD PTR _len$80705[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [edx+5820], ecx
	jle	$LN8@send_tree
	mov	eax, DWORD PTR _s$[ebp]
	movzx	ecx, WORD PTR [eax+2756]
	mov	DWORD PTR _val$80708[ebp], ecx
	movzx	edx, WORD PTR _val$80708[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80705[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN8@send_tree:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80705[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN7@send_tree:
	mov	DWORD PTR _len$80719[ebp], 7
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$80719[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN6@send_tree
	mov	ecx, DWORD PTR _count$[ebp]
	sub	ecx, 11					; 0000000bH
	mov	DWORD PTR _val$80722[ebp], ecx
	movzx	edx, WORD PTR _val$80722[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80719[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN6@send_tree:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80719[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN31@send_tree:
...
; Function compile flags: /Odtp
tv303 = -72						; size = 4
_val$81041 = -68					; size = 4
_len$81038 = -64					; size = 4
_val$81027 = -60					; size = 4
_len$81024 = -56					; size = 4
_val$81011 = -52					; size = 4
_len$81008 = -48					; size = 4
_val$80997 = -44					; size = 4
_len$80994 = -40					; size = 4
_val$80982 = -36					; size = 4
_len$80979 = -32					; size = 4
_val$80967 = -28					; size = 4
_len$80964 = -24					; size = 4
_dist$ = -20						; size = 4
_lc$ = -16						; size = 4
_lx$ = -12						; size = 4
_code$ = -8						; size = 4
...
; 1079 :             send_code(s, lc, ltree); /* send a literal byte */
	...
	movzx	eax, WORD PTR [edx+ecx*4+2]
	mov	DWORD PTR _len$80964[ebp], eax
	mov	ecx, 16					; 00000010H
	sub	ecx, DWORD PTR _len$80964[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [edx+5820], ecx
	jle	$LN15@compress_b
	mov	eax, DWORD PTR _lc$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80964[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
; 1084 :             send_code(s, code+LITERALS+1, ltree); /* send the length code */
	...
	mov	DWORD PTR _len$80979[ebp], ecx
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$80979[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN12@compress_b
	...
	mov	DWORD PTR _val$80982[ebp], eax
	movzx	edx, WORD PTR _val$80982[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80979[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN12@compress_b:
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	add	ecx, DWORD PTR _len$80979[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5820], ecx
$LN11@compress_b:
...
; 1088 :                 send_bits(s, lc, extra);       /* send the extra length bits */
	...
	mov	DWORD PTR _len$80994[ebp], ecx
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$80994[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN9@compress_b
	mov	ecx, DWORD PTR _lc$[ebp]
	mov	DWORD PTR _val$80997[ebp], ecx
	movzx	edx, WORD PTR _val$80997[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$80994[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN9@compress_b:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$80994[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN10@compress_b:
...
; 1094 :             send_code(s, code, dtree);       /* send the distance code */
	...
	movzx	ecx, WORD PTR [eax+edx*4+2]
	mov	DWORD PTR _len$81008[ebp], ecx
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$81008[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN7@compress_b
	mov	ecx, DWORD PTR _code$[ebp]
	...
	movzx	eax, WORD PTR [edx+ecx*4]
	mov	DWORD PTR _val$81011[ebp], eax
	movzx	edx, WORD PTR _val$81011[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$81008[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN7@compress_b:
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	add	ecx, DWORD PTR _len$81008[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5820], ecx
$LN6@compress_b:
...
; 1098 :                 send_bits(s, dist, extra);   /* send the extra distance bits */
	...
	mov	ecx, DWORD PTR _extra$[ebp]
	mov	DWORD PTR _len$81024[ebp], ecx
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$81024[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN4@compress_b
	mov	ecx, DWORD PTR _dist$[ebp]
	mov	DWORD PTR _val$81027[ebp], ecx
	movzx	edx, WORD PTR _val$81027[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$81024[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN4@compress_b:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$81024[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN18@compress_b:
...
; 1108 :     send_code(s, END_BLOCK, ltree);
	...
	mov	ecx, DWORD PTR _ltree$[ebp]
	movzx	edx, WORD PTR [ecx+1026]
	mov	DWORD PTR _len$81038[ebp], edx
	mov	eax, 16					; 00000010H
	sub	eax, DWORD PTR _len$81038[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [ecx+5820], eax
	jle	$LN2@compress_b
	mov	edx, DWORD PTR _ltree$[ebp]
	movzx	eax, WORD PTR [edx+1024]
	mov	DWORD PTR _val$81041[ebp], eax
	movzx	edx, WORD PTR _val$81041[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	mov	ecx, DWORD PTR _len$81038[ebp]
	lea	edx, DWORD PTR [ecx+eax-16]
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5820], edx
...
$LN2@compress_b:
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5820]
	add	eax, DWORD PTR _len$81038[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5820], eax
$LN21@compress_b:
...
; 1141 :             || s->dyn_ltree[13].Freq != 0)
	...
	mov	edx, DWORD PTR _s$[ebp]
	movzx	eax, WORD PTR [edx+188]
	test	eax, eax
	jne	SHORT $LN5@detect_dat
	mov	ecx, DWORD PTR _s$[ebp]
	movzx	edx, WORD PTR [ecx+200]
	test	edx, edx
