; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\theclashingfritz\source\repos\INIFileParser\zlib\crc32.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\theclashingfritz\source\repos\inifileparser\zlib\crc32.c
_TEXT	SEGMENT
...
; 218  :         endian = 1;
	...
	mov	DWORD PTR _endian$80259[ebp], 1

; 219  :         if (*((unsigned char *)(&endian)))

	movzx	ecx, BYTE PTR _endian$80259[ebp]
	test	ecx, ecx
...
; 283  :         DOLIT32;
	...
	shr	eax, 8
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc_table[edx*4+3072]
	xor	ecx, DWORD PTR _crc_table[eax*4+2048]
	mov	edx, DWORD PTR _c$[ebp]
	shr	edx, 16					; 00000010H
	and	edx, 255				; 000000ffH
	xor	ecx, DWORD PTR _crc_table[edx*4+1024]
	mov	eax, DWORD PTR _c$[ebp]
	...
	shr	edx, 8
	and	edx, 255				; 000000ffH
	mov	eax, DWORD PTR _crc_table[ecx*4+3072]
	xor	eax, DWORD PTR _crc_table[edx*4+2048]
	mov	ecx, DWORD PTR _c$[ebp]
	shr	ecx, 16					; 00000010H
	and	ecx, 255				; 000000ffH
	xor	eax, DWORD PTR _crc_table[ecx*4+1024]
	mov	edx, DWORD PTR _c$[ebp]
...
; 323  :         DOBIG32;
	...
	shr	eax, 8
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc_table[edx*4+4096]
	xor	ecx, DWORD PTR _crc_table[eax*4+5120]
	mov	edx, DWORD PTR _c$[ebp]
	shr	edx, 16					; 00000010H
	and	edx, 255				; 000000ffH
	xor	ecx, DWORD PTR _crc_table[edx*4+6144]
	mov	eax, DWORD PTR _c$[ebp]
	shr	eax, 24					; 00000018H
	xor	ecx, DWORD PTR _crc_table[eax*4+7168]
	mov	DWORD PTR _c$[ebp], ecx
	mov	ecx, DWORD PTR _buf4$[ebp]
	mov	edx, DWORD PTR _c$[ebp]
	xor	edx, DWORD PTR [ecx]
	...
	shr	edx, 8
	and	edx, 255				; 000000ffH
	mov	eax, DWORD PTR _crc_table[ecx*4+4096]
	xor	eax, DWORD PTR _crc_table[edx*4+5120]
	mov	ecx, DWORD PTR _c$[ebp]
	shr	ecx, 16					; 00000010H
	and	ecx, 255				; 000000ffH
	xor	eax, DWORD PTR _crc_table[ecx*4+6144]
	mov	edx, DWORD PTR _c$[ebp]
	shr	edx, 24					; 00000018H
	xor	eax, DWORD PTR _crc_table[edx*4+7168]
	mov	DWORD PTR _c$[ebp], eax
	mov	eax, DWORD PTR _buf4$[ebp]
	mov	ecx, DWORD PTR _c$[ebp]
	xor	ecx, DWORD PTR [eax]
...
; 405  :         if (len2 & 1)
	...
	mov	DWORD PTR tv142[ebp+4], edx
	mov	eax, DWORD PTR tv142[ebp]
	or	eax, DWORD PTR tv142[ebp+4]
