...
; 295  :         windowBits -= 16;
	...
	mov	DWORD PTR _windowBits$[ebp], ecx
$LN8@deflateIni:
...
; 308  :     s->status = INIT_STATE;     /* to pass state test in deflateReset() */
	...
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+4], 42			; 0000002aH
...
; 592  :         int err = deflate(strm, Z_BLOCK);
	...
	push	edx
	call	_deflate@8
	mov	DWORD PTR _err$80594[ebp], eax

; 593  :         if (err == Z_STREAM_ERROR)

	cmp	DWORD PTR _err$80594[ebp], -2		; fffffffeH
	jne	SHORT $LN6@deflatePar

; 594  :             return err;

	mov	eax, DWORD PTR _err$80594[ebp]
	jmp	$LN13@deflatePar
$LN6@deflatePar:
...
; 683  :             str = s->gzhead->name;
	...
	mov	ecx, DWORD PTR [eax+28]
	mov	edx, DWORD PTR [ecx+28]
	mov	DWORD PTR _str$80631[ebp], edx

; 684  :             if (str != Z_NULL)

	cmp	DWORD PTR _str$80631[ebp], 0
...
; 687  :                 } while (*str++);
	...
	mov	ecx, DWORD PTR _str$80631[ebp]
	movzx	edx, BYTE PTR [ecx]
	mov	eax, DWORD PTR _str$80631[ebp]
	add	eax, 1
	mov	DWORD PTR _str$80631[ebp], eax
	test	edx, edx
...
; 692  :                 } while (*str++);
	...
	mov	edx, DWORD PTR _str$80631[ebp]
	movzx	eax, BYTE PTR [edx]
	mov	ecx, DWORD PTR _str$80631[ebp]
	add	ecx, 1
	mov	DWORD PTR _str$80631[ebp], ecx
	test	eax, eax
...
tv258 = -56						; size = 4
tv259 = -52						; size = 4
_bstate$80786 = -48					; size = 4
_val$80760 = -44					; size = 4
_beg$80759 = -40					; size = 4
_val$80742 = -36					; size = 4
_beg$80741 = -32					; size = 4
_copy$80729 = -28					; size = 4
_left$80725 = -24					; size = 4
_beg$80724 = -20					; size = 4
_header$80679 = -16					; size = 4
_level_flags$80680 = -12				; size = 4
_old_flush$ = -8					; size = 4
_s$ = -4						; size = 4
_strm$ = 8						; size = 4
_flush$ = 12						; size = 4
...
; 778  :         ERR_RETURN(strm, Z_STREAM_ERROR);
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR _z_errmsg+16
...
; 780  :     if (strm->avail_out == 0) ERR_RETURN(strm, Z_BUF_ERROR);
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR _z_errmsg+28
	mov	DWORD PTR [ecx+24], edx
	mov	eax, -5					; fffffffbH
	jmp	$LN96@deflate
$LN90@deflate:
...
; 828  :         if (s->strstart != 0) header |= PRESET_DICT;
	...
	mov	edx, DWORD PTR _header$80679[ebp]
	or	edx, 32					; 00000020H
	mov	DWORD PTR _header$80679[ebp], edx
$LN76@deflate:
...
; 831  :         putShortMSB(s, header);
	...
	mov	ecx, DWORD PTR _header$80679[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	push	edx
	call	_putShortMSB
...
; 852  :         put_byte(s, 31);
	...
	mov	BYTE PTR [eax+edx], 31			; 0000001fH
	mov	eax, DWORD PTR _s$[ebp]
...
; 863  :                       4 : 0));
	...
	jne	SHORT $LN100@deflate
	mov	DWORD PTR tv259[ebp], 2
	jmp	SHORT $LN101@deflate
$LN100@deflate:
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+136], 2
	jge	SHORT $LN98@deflate
	mov	ecx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [ecx+132], 2
	jl	SHORT $LN98@deflate
	mov	DWORD PTR tv258[ebp], 0
	jmp	SHORT $LN99@deflate
$LN98@deflate:
	mov	DWORD PTR tv258[ebp], 4
$LN99@deflate:
...
; 900  :     if (s->status == EXTRA_STATE) {
	...
	mov	ecx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [ecx+4], 69			; 00000045H
	jne	$LN67@deflate
...
; 902  :             ulg beg = s->pending;   /* start of bytes to update crc */
	...
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR _beg$80724[ebp], edx
...
; 903  :             uInt left = (s->gzhead->extra_len & 0xffff) - s->gzindex;
	...
	mov	DWORD PTR _left$80725[ebp], edx
$LN65@deflate:
...
; 904  :             while (s->pending + left > s->pending_buf_size) {
	...
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	add	edx, DWORD PTR _left$80725[ebp]
	mov	eax, DWORD PTR _s$[ebp]
...
; 909  :                 HCRC_UPDATE(beg);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	cmp	eax, DWORD PTR _beg$80724[ebp]
	jbe	SHORT $LN62@deflate
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	sub	edx, DWORD PTR _beg$80724[ebp]
	push	edx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	add	ecx, DWORD PTR _beg$80724[ebp]
	push	ecx
	mov	edx, DWORD PTR _strm$[ebp]
...
; 910  :                 s->gzindex += copy;
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	add	ecx, DWORD PTR _copy$80729[ebp]
	mov	edx, DWORD PTR _s$[ebp]
...
; 916  :                 beg = 0;
	...
	mov	DWORD PTR _beg$80724[ebp], 0

; 917  :                 left -= copy;

	mov	eax, DWORD PTR _left$80725[ebp]
	sub	eax, DWORD PTR _copy$80729[ebp]
	mov	DWORD PTR _left$80725[ebp], eax
...
; 920  :                     s->gzhead->extra + s->gzindex, left);
	...
	mov	ecx, DWORD PTR _left$80725[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+28]
	mov	ecx, DWORD PTR [eax+16]
...
; 921  :             s->pending += left;
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	add	ecx, DWORD PTR _left$80725[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+20], ecx
$LN58@deflate:
...
; 927  :     if (s->status == NAME_STATE) {
	...
	mov	edx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [edx+4], 73			; 00000049H
	jne	$LN54@deflate
...
; 929  :             ulg beg = s->pending;   /* start of bytes to update crc */
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	mov	DWORD PTR _beg$80741[ebp], eax
$LN52@deflate:
...
; 933  :                     HCRC_UPDATE(beg);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	cmp	ecx, DWORD PTR _beg$80741[ebp]
	jbe	SHORT $LN47@deflate
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	sub	eax, DWORD PTR _beg$80741[ebp]
	push	eax
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	add	edx, DWORD PTR _beg$80741[ebp]
	push	edx
	mov	eax, DWORD PTR _strm$[ebp]
	mov	ecx, DWORD PTR [eax+48]
	push	ecx
...
; 939  :                     beg = 0;
	...
	mov	DWORD PTR _beg$80741[ebp], 0
$LN49@deflate:
...
; 941  :                 val = s->gzhead->name[s->gzindex++];
	...
	mov	DWORD PTR _val$80742[ebp], eax
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+32]
	add	edx, 1
	mov	eax, DWORD PTR _s$[ebp]
...
; 942  :                 put_byte(s, val);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	al, BYTE PTR _val$80742[ebp]
	mov	BYTE PTR [edx+ecx], al
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	add	edx, 1
...
; 943  :             } while (val != 0);
	...
	cmp	DWORD PTR _val$80742[ebp], 0
	jne	$LN52@deflate
$LN43@deflate:
...
; 947  :         s->status = COMMENT_STATE;
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+4], 91			; 0000005bH
$LN54@deflate:
...
; 951  :             ulg beg = s->pending;   /* start of bytes to update crc */
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR _beg$80759[ebp], ecx
$LN37@deflate:
...
; 955  :                     HCRC_UPDATE(beg);
	...
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	cmp	edx, DWORD PTR _beg$80759[ebp]
	jbe	SHORT $LN32@deflate
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR _beg$80759[ebp]
	push	ecx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+8]
	add	eax, DWORD PTR _beg$80759[ebp]
	push	eax
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	edx, DWORD PTR [ecx+48]
	push	edx
...
; 961  :                     beg = 0;
	...
	mov	DWORD PTR _beg$80759[ebp], 0
$LN34@deflate:
...
; 963  :                 val = s->gzhead->comment[s->gzindex++];
	...
	mov	DWORD PTR _val$80760[ebp], edx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
...
; 964  :                 put_byte(s, val);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	mov	dl, BYTE PTR _val$80760[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	add	ecx, 1
...
; 965  :             } while (val != 0);
	...
	cmp	DWORD PTR _val$80760[ebp], 0
	jne	$LN37@deflate
$LN28@deflate:
...
; 966  :             HCRC_UPDATE(beg);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	cmp	eax, DWORD PTR _beg$80759[ebp]
	jbe	SHORT $LN27@deflate
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	sub	edx, DWORD PTR _beg$80759[ebp]
	push	edx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	add	ecx, DWORD PTR _beg$80759[ebp]
	push	ecx
	mov	edx, DWORD PTR _strm$[ebp]
	mov	eax, DWORD PTR [edx+48]
	push	eax
...
; 997  :         (flush != Z_NO_FLUSH && s->status != FINISH_STATE)) {
	...
	je	$LN19@deflate
	mov	edx, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [edx+4], 666			; 0000029aH
	je	$LN19@deflate
$LN18@deflate:
...
$LN111@deflate:
	...
	mov	DWORD PTR _bstate$80786[ebp], ecx

; 1004 : 
; 1005 :         if (bstate == finish_started || bstate == finish_done) {

	cmp	DWORD PTR _bstate$80786[ebp], 2
	je	SHORT $LN16@deflate
	cmp	DWORD PTR _bstate$80786[ebp], 3
...
; 1008 :         if (bstate == need_more || bstate == finish_started) {
	...
	cmp	DWORD PTR _bstate$80786[ebp], 0
...
; 1021 :         if (bstate == block_done) {
	...
	cmp	DWORD PTR _bstate$80786[ebp], 1
	jne	$LN19@deflate
...
_lm_init ENDP
; Function compile flags: /Odtp
_curr$80966 = -24					; size = 4
_init$80968 = -20					; size = 4
_str$80958 = -16					; size = 4
_wsize$ = -12						; size = 4
_more$ = -8						; size = 4
_n$ = -4						; size = 4
_s$ = 8							; size = 4
...
; 1539 :             uInt str = s->strstart - s->insert;
	...
	mov	DWORD PTR _str$80958[ebp], ecx

; 1540 :             s->ins_h = s->window[str];

	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+56]
	mov	ecx, DWORD PTR _str$80958[ebp]
...
; 1548 :                 s->prev[str & s->w_mask] = s->head[s->ins_h];
	...
	mov	eax, DWORD PTR [edx+68]
	mov	edx, DWORD PTR _s$[ebp]
	mov	esi, DWORD PTR _str$80958[ebp]
...
; 1550 :                 s->head[s->ins_h] = (Pos)str;
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+68]
	mov	ax, WORD PTR _str$80958[ebp]
...
; 1571 :         ulg curr = s->strstart + (ulg)(s->lookahead);
	...
	mov	DWORD PTR _curr$80966[ebp], eax
...
; 1574 :         if (s->high_water < curr) {
	...
	cmp	eax, DWORD PTR _curr$80966[ebp]
...
; 1578 :             init = s->window_size - curr;
	...
	sub	edx, DWORD PTR _curr$80966[ebp]
	mov	DWORD PTR _init$80968[ebp], edx

; 1579 :             if (init > WIN_INIT)

	cmp	DWORD PTR _init$80968[ebp], 258		; 00000102H
	jbe	SHORT $LN4@fill_windo

; 1580 :                 init = WIN_INIT;

	mov	DWORD PTR _init$80968[ebp], 258		; 00000102H
$LN4@fill_windo:

; 1581 :             zmemzero(s->window + curr, (unsigned)init);

	mov	eax, DWORD PTR _init$80968[ebp]
	push	eax
	push	0
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+56]
	add	edx, DWORD PTR _curr$80966[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
...
; 1582 :             s->high_water = curr + init;
	...
	mov	eax, DWORD PTR _curr$80966[ebp]
	add	eax, DWORD PTR _init$80968[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
...
; 1584 :         else if (s->high_water < (ulg)curr + WIN_INIT) {
	...
	mov	edx, DWORD PTR _curr$80966[ebp]
...
; 1589 :             init = (ulg)curr + WIN_INIT - s->high_water;
	...
	mov	ecx, DWORD PTR _curr$80966[ebp]
	add	ecx, 258				; 00000102H
	mov	edx, DWORD PTR _s$[ebp]
	sub	ecx, DWORD PTR [edx+5824]
	mov	DWORD PTR _init$80968[ebp], ecx
...
; 1590 :             if (init > s->window_size - s->high_water)
	...
	cmp	DWORD PTR _init$80968[ebp], edx
...
; 1593 :             s->high_water += init;
	...
	add	edx, DWORD PTR _init$80968[ebp]
	mov	eax, DWORD PTR _s$[ebp]
...
; 1799 :     have = MIN(s->pending_buf_size - have, MAX_STORED);
	...
	mov	DWORD PTR tv332[ebp], 65535		; 0000ffffH
...
; 1868 :                            s->match_length - MIN_MATCH, bflush);
	...
	mov	dx, WORD PTR _dist$81039[ebp]
	sub	dx, 1
	mov	WORD PTR _dist$81039[ebp], dx
	movzx	eax, BYTE PTR _len$81037[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$81037[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	edx, WORD PTR _dist$81039[ebp]
	cmp	edx, 256				; 00000100H
	jge	SHORT $LN23@deflate_fa
	movzx	eax, WORD PTR _dist$81039[ebp]
...
; 1904 :             _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	movzx	ecx, BYTE PTR _cc$81048[ebp]
	mov	edx, DWORD PTR _s$[ebp]
...
; 1356 :         len = MAX_MATCH - (int)(strend - scan);
	...
	mov	ecx, DWORD PTR _strend$[ebp]
	sub	ecx, DWORD PTR _scan$[ebp]
...
; 1361 :         if (len > best_len) {
	...
	mov	ecx, DWORD PTR _len$[ebp]
	cmp	ecx, DWORD PTR _best_len$[ebp]
...
; 1368 :             scan_end1  = scan[best_len-1];
	...
	mov	eax, DWORD PTR _scan$[ebp]
	add	eax, DWORD PTR _best_len$[ebp]
	mov	cl, BYTE PTR [eax-1]
	mov	BYTE PTR _scan_end1$[ebp], cl
...
; 1373 :              && --chain_length != 0);
	...
	and	ecx, DWORD PTR _wmask$[ebp]
	mov	edx, DWORD PTR _prev$[ebp]
	movzx	eax, WORD PTR [edx+ecx*2]
	mov	DWORD PTR _cur_match$[ebp], eax
	mov	ecx, DWORD PTR _cur_match$[ebp]
	cmp	ecx, DWORD PTR _limit$[ebp]
	jbe	SHORT $LN11@longest_ma
	mov	edx, DWORD PTR _chain_length$[ebp]
	sub	edx, 1
	mov	DWORD PTR _chain_length$[ebp], edx
	jne	$LN13@longest_ma
$LN11@longest_ma:
...
; 1375 :     if ((uInt)best_len <= s->lookahead) return (uInt)best_len;
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR _best_len$[ebp]
	cmp	ecx, DWORD PTR [eax+116]
	ja	SHORT $LN1@longest_ma
	mov	eax, DWORD PTR _best_len$[ebp]
	jmp	SHORT $LN16@longest_ma
$LN1@longest_ma:
...
_cc$81117 = -22						; size = 1
_cc$81107 = -21						; size = 1
_dist$81091 = -20					; size = 2
_len$81089 = -13					; size = 1
_max_insert$81088 = -12					; size = 4
_hash_head$ = -8					; size = 4
_bflush$ = -4						; size = 4
_s$ = 8							; size = 4
_flush$ = 12						; size = 4
...
; 1987 :             uInt max_insert = s->strstart + s->lookahead - MIN_MATCH;
	...
	mov	DWORD PTR _max_insert$81088[ebp], edx
...
; 1993 :                            s->prev_length - MIN_MATCH, bflush);
	...
	sub	ecx, 3
	mov	BYTE PTR _len$81089[ebp], cl
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+108]
	sub	eax, 1
	mov	ecx, DWORD PTR _s$[ebp]
	sub	eax, DWORD PTR [ecx+100]
	mov	WORD PTR _dist$81091[ebp], ax
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5792]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+5796]
	mov	cx, WORD PTR _dist$81091[ebp]
	mov	WORD PTR [edx+eax*2], cx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5784]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+5792]
	mov	cl, BYTE PTR _len$81089[ebp]
	mov	BYTE PTR [eax+edx], cl
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5792]
	add	eax, 1
	mov	ecx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [ecx+5792], eax
	mov	dx, WORD PTR _dist$81091[ebp]
	sub	dx, 1
	mov	WORD PTR _dist$81091[ebp], dx
	movzx	eax, BYTE PTR _len$81089[ebp]
	movzx	ecx, BYTE PTR __length_code[eax]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+1176]
	add	ax, 1
	movzx	ecx, BYTE PTR _len$81089[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	WORD PTR [ecx+edx*4+1176], ax
	movzx	edx, WORD PTR _dist$81091[ebp]
	cmp	edx, 256				; 00000100H
	jge	SHORT $LN29@deflate_sl
	movzx	eax, WORD PTR _dist$81091[ebp]
	movzx	ecx, BYTE PTR __dist_code[eax]
...
; 2003 :                 if (++s->strstart <= max_insert) {
	...
	cmp	ecx, DWORD PTR _max_insert$81088[ebp]
	ja	$LN15@deflate_sl
...
; 2019 :             _tr_tally_lit(s, s->window[s->strstart-1], bflush);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5792], edx
	movzx	ecx, BYTE PTR _cc$81107[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+148]
	add	ax, 1
	movzx	ecx, BYTE PTR _cc$81107[ebp]
...
; 2038 :         _tr_tally_lit(s, s->window[s->strstart-1], bflush);
	...
	movzx	eax, BYTE PTR _cc$81117[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
...
tv210 = -32						; size = 4
_cc$81160 = -25						; size = 1
_dist$81157 = -24					; size = 2
_len$81155 = -17					; size = 1
_strend$ = -16						; size = 4
_bflush$ = -12						; size = 4
_scan$ = -8						; size = 4
_prev$ = -4						; size = 4
...
; 2102 :             _tr_tally_dist(s, 1, s->match_length - MIN_MATCH, bflush);
	...
	mov	ecx, DWORD PTR [eax+96]
	sub	ecx, 3
	mov	BYTE PTR _len$81155[ebp], cl
	mov	edx, 1
	mov	WORD PTR _dist$81157[ebp], dx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5796]
	mov	dx, WORD PTR _dist$81157[ebp]
	mov	WORD PTR [eax+ecx*2], dx
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5784]
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5792]
	mov	dl, BYTE PTR _len$81155[ebp]
	mov	BYTE PTR [ecx+eax], dl
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5792]
	add	ecx, 1
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	mov	ax, WORD PTR _dist$81157[ebp]
	sub	ax, 1
	mov	WORD PTR _dist$81157[ebp], ax
	movzx	ecx, BYTE PTR _len$81155[ebp]
	movzx	edx, BYTE PTR __length_code[ecx]
	mov	eax, DWORD PTR _s$[ebp]
	mov	cx, WORD PTR [eax+edx*4+1176]
	add	cx, 1
	movzx	edx, BYTE PTR _len$81155[ebp]
	movzx	eax, BYTE PTR __length_code[edx]
	mov	edx, DWORD PTR _s$[ebp]
	mov	WORD PTR [edx+eax*4+1176], cx
	movzx	eax, WORD PTR _dist$81157[ebp]
	cmp	eax, 256				; 00000100H
	jge	SHORT $LN23@deflate_rl
	movzx	ecx, WORD PTR _dist$81157[ebp]
...
; 2110 :             _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	DWORD PTR [eax+5792], edx
	movzx	ecx, BYTE PTR _cc$81160[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	mov	ax, WORD PTR [edx+ecx*4+148]
	add	ax, 1
	movzx	ecx, BYTE PTR _cc$81160[ebp]
...
; 2150 :         _tr_tally_lit (s, s->window[s->strstart], bflush);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	DWORD PTR [edx+5792], ecx
	movzx	eax, BYTE PTR _cc$81193[ebp]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	dx, WORD PTR [ecx+eax*4+148]
	add	dx, 1
	movzx	eax, BYTE PTR _cc$81193[ebp]
