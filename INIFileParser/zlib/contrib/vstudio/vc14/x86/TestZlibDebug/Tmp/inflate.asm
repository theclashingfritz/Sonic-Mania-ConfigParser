...
CONST	ENDS
_DATA	SEGMENT
$SG80395 DB	'1.2.11', 00H
	ORG $+1
$SG80521 DB	'incorrect header check', 00H
	ORG $+1
$SG80525 DB	'unknown compression method', 00H
	ORG $+1
$SG80535 DB	'invalid window size', 00H
$SG80555 DB	'unknown compression method', 00H
	ORG $+1
$SG80558 DB	'unknown header flags set', 00H
	ORG $+3
$SG80699 DB	'header crc mismatch', 00H
$SG80766 DB	'invalid block type', 00H
	ORG $+1
$SG80789 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG80832 DB	'too many length or distance symbols', 00H
$SG80861 DB	'invalid code lengths set', 00H
	ORG $+3
$SG80902 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG80955 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG80963 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG80967 DB	'invalid literal/lengths set', 00H
$SG80971 DB	'invalid distances set', 00H
	ORG $+2
$SG81020 DB	'invalid literal/length code', 00H
$SG81075 DB	'invalid distance code', 00H
	ORG $+2
$SG81103 DB	'invalid distance too far back', 00H
	ORG $+2
$SG81133 DB	'incorrect data check', 00H
	ORG $+3
$SG81153 DB	'incorrect length check', 00H
_DATA	ENDS
...
; 230  :     state->mode = HEAD;     /* to pass state test in inflateReset2() */
	...
	mov	eax, DWORD PTR _state$[ebp]
	mov	DWORD PTR [eax+4], 16180		; 00003f34H
...
; 656  :         switch (state->mode) {
	...
	cmp	DWORD PTR tv83[ebp], 30			; 0000001eH
	ja	$LN12@inflate
	mov	edx, DWORD PTR tv83[ebp]
	jmp	DWORD PTR $LN513@inflate[edx*4]
$LN490@inflate:
...
; 681  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG80521
...
; 686  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG80525
...
; 695  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG80535
...
; 710  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG80555
...
; 715  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG80558
...
; 722  :                 CRC2(state->check, hold);
	...
	mov	BYTE PTR _hbuf$[ebp], cl
	mov	edx, DWORD PTR _hold$[ebp]
	shr	edx, 8
	mov	BYTE PTR _hbuf$[ebp+1], dl
	push	2
...
; 798  :             state->mode = COMMENT;
	...
	mov	edx, DWORD PTR _state$[ebp]
	mov	DWORD PTR [edx+4], 16187		; 00003f3bH
$LN362@inflate:
...
; 823  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG80699
...
; 860  :             switch (BITS(2)) {
	...
	cmp	DWORD PTR tv603[ebp], 3
	ja	SHORT $LN286@inflate
	mov	edx, DWORD PTR tv603[ebp]
	jmp	DWORD PTR $LN514@inflate[edx*4]
$LN294@inflate:
...
; 882  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG80766
...
; 891  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG80789
...
; 930  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG80832
...
; 952  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG80861
...
; 975  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG80902
...
; 998  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG80955
...
; 1012 :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG80963
...
; 1026 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG80967
...
; 1035 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG80971
...
; 1040 :             state->mode = LEN_;
	...
	mov	ecx, DWORD PTR _state$[ebp]
	mov	DWORD PTR [ecx+4], 16199		; 00003f47H
...
; 1077 :                 state->mode = LIT;
	...
	mov	ecx, DWORD PTR _state$[ebp]
	mov	DWORD PTR [ecx+4], 16205		; 00003f4dH
...
; 1087 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG81020
...
; 1092 :             state->mode = LENEXT;
	...
	mov	ecx, DWORD PTR _state$[ebp]
	mov	DWORD PTR [ecx+4], 16201		; 00003f49H
$LN113@inflate:
...
; 1101 :             state->was = state->length;
	...
	mov	eax, DWORD PTR _state$[ebp]
	mov	ecx, DWORD PTR [eax+68]
	mov	DWORD PTR [edx+7116], ecx

; 1102 :             state->mode = DIST;

	mov	edx, DWORD PTR _state$[ebp]
	mov	DWORD PTR [edx+4], 16202		; 00003f4aH
$LN98@inflate:
...
; 1123 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG81075
...
; 1129 :             state->mode = DISTEXT;
	...
	mov	ecx, DWORD PTR _state$[ebp]
	mov	DWORD PTR [ecx+4], 16203		; 00003f4bH
$LN76@inflate:
...
; 1153 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG81103
...
; 1212 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG81133
...
; 1225 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG81153
...
; 1271 :                       (state->mode == LEN_ || state->mode == COPY_ ? 256 : 0);
	...
	mov	ecx, DWORD PTR _state$[ebp]
	cmp	DWORD PTR [ecx+4], 16199		; 00003f47H
	je	SHORT $LN511@inflate
	mov	edx, DWORD PTR _state$[ebp]
	cmp	DWORD PTR [edx+4], 16194		; 00003f42H
	je	SHORT $LN511@inflate
	mov	DWORD PTR tv1426[ebp], 0
	jmp	SHORT $LN512@inflate
$LN511@inflate:
	mov	DWORD PTR tv1426[ebp], 256		; 00000100H
$LN512@inflate:
	mov	eax, DWORD PTR _state$[ebp]
...
; 1458 :     return state->mode == STORED && state->bits == 0;
	...
	jne	SHORT $LN4@inflateSyn@2
	mov	ecx, DWORD PTR _state$[ebp]
	cmp	DWORD PTR [ecx+64], 0
	jne	SHORT $LN4@inflateSyn@2
	mov	DWORD PTR tv72[ebp], 1
	jmp	SHORT $LN5@inflateSyn@2
$LN4@inflateSyn@2:
