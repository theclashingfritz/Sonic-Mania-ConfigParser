; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\theclashingfritz\source\repos\INIFileParser\zlib\zutil.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG82291 DB	'need dictionary', 00H
$SG82293 DB	'stream end', 00H
	ORG $+1
$SG82297 DB	'file error', 00H
	ORG $+1
$SG82299 DB	'stream error', 00H
	ORG $+3
$SG82301 DB	'data error', 00H
	ORG $+1
$SG82303 DB	'insufficient memory', 00H
$SG82305 DB	'buffer error', 00H
	ORG $+3
$SG82307 DB	'incompatible version', 00H
	ORG $+3
$SG82311 DB	'1.2.11', 00H
_DATA	ENDS
PUBLIC	_zlibVersion@0
; Function compile flags: /Odtp
; File c:\users\theclashingfritz\source\repos\inifileparser\zlib\zutil.c
_TEXT	SEGMENT
_zlibVersion@0 PROC
